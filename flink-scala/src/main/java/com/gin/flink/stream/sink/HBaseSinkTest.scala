package com.gin.flink.scala.stream.sink

import java.util.{Date, Properties}

import com.gin.flink.scala.stream.util.DateUtils
  ...
  def main(args: Array[String]): Unit = {
    ...
    stream.map(data => {
      ...
      override def open(parameters: Configuration): Unit = {
        ...
        conf.set("hbase.zookeeper.quorum","node02:2181,node03:2181,node04:2181")
